...
import Image24 from "../img/happy-little-girl-in-protective-hat-riding-her-bik-W9757CG.jpg";
      ...
      <div>
        ...
        <Container>
            ...
            <Col>
              <Card className="Home-Image-Card">
                <Card.Body>
                  <Card.Img
                    src={Image1}
                    className="Home-Image Home-Image-a"
                  ></Card.Img>
                  <Card.Img
                    src={Image2}
                    className="Home-Image Home-Image-b"
                  ></Card.Img>
                </Card.Body>
              </Card>
            </Col>
          ...
          <Container>
            ...
            <Row className="About-Head-Row" style={{ marginBottom: "20px" }}>
              <Col xs lg="5"></Col>
              <Col>
                <hr />
              </Col>
                ...
                <Card className="Home-Facilities-Card">
                  <Card.Body>
                    <Row>
                      <Col
                        xs={3}
                        className="Home-Facilities-Icon-Wrapper"
                      ...
                      <Col>
                        <Card.Title
                          className="Home-Facilities-Card-Title"
          ...
          <Container>
            ...
            <Container className="Home-button-container">
              <Button variant="primary" type="button" className="Home-Button-a">
                Discover More
              </Button>
            </Container>
          </Container>
                  ...
                  <Card.Body>
                    ...
                    >
                      <Row>
                        <Col>
                          <div
                            className="Home-Classes-Info-Wrapper"
                            style={{ backgroundColor: "var(--orange)" }}
                          >
                            <Card.Text className="Home-Classes-Info-Big-Text">
                              58+
                            </Card.Text>
            ...
            <Row>
              <Col>
                <Card className="Contact-contactHeader mb-3">
                  <Card.Title className="Contact-headerTitle mt-5">
                    Contact Us for Further Information
                  </Card.Title>
                  <img src={DotsWithLines} style={{ width: "300px" }}></img>
                  <Card.Text className="Contact-headerBody mt-3 mb-4">
